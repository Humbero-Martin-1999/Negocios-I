...
export class LeggingsComponent {
  productos = [
    ...
    { id: 2, nombre: 'Legging Deportivo Azul Marino', precio: 1399, img: 'LAM.jpg' },
    { id: 3, nombre: 'Legging Deportivo Marron', precio: 1199, img: 'LMAR.jpg' },
    ...
    { id: 10, nombre: 'Legging Deportivo Ultra violeta', precio: 1299, img: 'LUV.jpg' },
    ...
    { id: 15, nombre: 'Legging Deportivo Verde Alpino', precio: 799, img: 'LVA.jpg' }
  ];
